...
namespace ChallengeABP.Alumnado.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AlumnadoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AlumnadoEfCoreEntityExtensionMappings to extend the IdentityUser entity
